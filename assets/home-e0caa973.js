import { e as jsx, j as jsxs, F as Fragment, L as Link, J as ClimbingBoxLoader, r as reactExports, s as useSearchParams, K as defaults, M as useNavigate, u as useWeb3, O as createSearchParams, H as HelmetExport, P as ConnectKitButton } from "./index-45183a87.js";
import { r as regexify, e as extractMessage, h as httpURL, i as tffs, j as toSpanList, l as lib } from "./TokenFilterForm.module-a937dab3.js";
import { H as Header } from "./Header-a175f750.js";
import { T as Tippy } from "./tippy-react.esm-8ffb4264.js";
import { R as ReactMarkdown } from "./react-markdown-214a305b.js";
import { u as useForm, C as Controller } from "./index.esm-9a70f60b.js";
...
const Actions = ({ token }) => {
  ...
  return /* @__PURE__ */ jsx("nav", { className: "actions", children: /* @__PURE__ */ jsxs("ul", { children: [
    ...
    /* @__PURE__ */ jsx("li", { className: "permissions", children: /* @__PURE__ */ jsx(Tippy, { content: "Adjust NFT Permissions", children: /* @__PURE__ */ jsx(Link, { to: `/permissions/${id}`, className: "content", children: "🔒" }) }) })
  ] }) });
};
...
const link = "_link_1dp5z_1";
const footer = "_footer_1dp5z_7";
const buttons = "_buttons_1dp5z_16";
const main = "_main_1dp5z_28";
const tyl = {
  link,
  footer,
  buttons,
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsxs("main", { className: tyl.main, children: [
      /* @__PURE__ */ jsx(
        TokenFilterForm,
        {
          ...{
    ...
    /* @__PURE__ */ jsx("footer", { className: tyl.footer, children: /* @__PURE__ */ jsxs("section", { className: tyl.buttons, children: [
      /* @__PURE__ */ jsx(Tippy, { content: "Add 10 More ’Chieves", children: /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => {
            if (visibleList.length > 0) {
      ...
      /* @__PURE__ */ jsx(Tippy, { content: `Scroll Down ${limit} ’Chieves`, children: /* @__PURE__ */ jsxs(
        "button",
        {
      ...
      /* @__PURE__ */ jsx(Tippy, { content: `Scroll Up ${limit} ’Chieves`, children: /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => setOffset((off) => off - limit),
          children: [
...
//# sourceMappingURL=home-e0caa973.js.map
